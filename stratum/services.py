...
class ServiceFactory(object):
    ...
    def lookup(cls, service_type, vendor=None):
        ...
        if vendor:
            try:
                ...
                raise custom_exceptions.ServiceNotFoundException(
    ...
    def register_service(cls, _cls, meta):
        ...
        log.msg("Registered %s for service '%s', vendor '%s' (default: %s)" % (_cls, service_type, service_vendor,
                                                                               is_default))
...
class ServiceDiscovery(GenericService):
    ...
    list_params.params = [
        ('method', 'string', 'Method to lookup for description and parameters.'),
    ]
